defmodule Bestnowelixirmysql.AfricastalkingtextsTest do
  ...
  describe "africastalkingtexts" do
    ...
    test "get_africastalkingtext!/1 returns the africastalkingtext with given id" do
      africastalkingtext = africastalkingtext_fixture()
      assert Africastalkingtexts.get_africastalkingtext!(africastalkingtext.id) == africastalkingtext
    end

    test "create_africastalkingtext/1 with valid data creates a africastalkingtext" do
      valid_attrs = %{cost: "some cost", messageId: "some messageId", messageParts: 42, number: 42, sentmessage: "some sentmessage", status: "some status", statusCode: 42}

      assert {:ok, %Africastalkingtext{} = africastalkingtext} = Africastalkingtexts.create_africastalkingtext(valid_attrs)
    ...
    test "create_africastalkingtext/1 with invalid data returns error changeset" do
      assert {:error, %Ecto.Changeset{}} = Africastalkingtexts.create_africastalkingtext(@invalid_attrs)
    end

    test "update_africastalkingtext/2 with valid data updates the africastalkingtext" do
      africastalkingtext = africastalkingtext_fixture()
      update_attrs = %{cost: "some updated cost", messageId: "some updated messageId", messageParts: 43, number: 43, sentmessage: "some updated sentmessage", status: "some updated status", statusCode: 43}

      assert {:ok, %Africastalkingtext{} = africastalkingtext} = Africastalkingtexts.update_africastalkingtext(africastalkingtext, update_attrs)
    ...
    test "update_africastalkingtext/2 with invalid data returns error changeset" do
      africastalkingtext = africastalkingtext_fixture()
      assert {:error, %Ecto.Changeset{}} = Africastalkingtexts.update_africastalkingtext(africastalkingtext, @invalid_attrs)
      assert africastalkingtext == Africastalkingtexts.get_africastalkingtext!(africastalkingtext.id)
    end

    test "delete_africastalkingtext/1 deletes the africastalkingtext" do
      africastalkingtext = africastalkingtext_fixture()
      assert {:ok, %Africastalkingtext{}} = Africastalkingtexts.delete_africastalkingtext(africastalkingtext)
      assert_raise Ecto.NoResultsError, fn -> Africastalkingtexts.get_africastalkingtext!(africastalkingtext.id) end
    end
